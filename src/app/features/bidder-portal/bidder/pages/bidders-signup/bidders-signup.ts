...
import { loginAnimations } from '../bidders-login/login-animations'; // ✅ adjust path if needed
...
@Component({
  ...
  styleUrl: './bidders-signup.scss',
  animations: loginAnimations
})
export class BiddersSignup implements OnInit, AfterViewInit, OnDestroy {
  ...
  // ✅ IMPORTANT: keep stable handlers so removeEventListener works
