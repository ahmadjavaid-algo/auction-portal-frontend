...
@Component({
  ...
  styleUrl: './bidders-resetpassword.scss',
  animations: loginAnimations
})
export class BiddersResetpassword implements OnInit, AfterViewInit, OnDestroy {
  ...
  // ===== ThreeJS (replicated from bidders-login) =====
  ...
  // IMPORTANT: keep stable references so removeEventListener works correctly
  ...
  ngOnInit(): void {
    ...
    if (!email || !code) {
      ...
      // keep form unusable if link is invalid
